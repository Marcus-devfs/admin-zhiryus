...
const Comissions: React.FC = () => {
    ...
    return (
        <>
            <SectionHeader title="Gestão de Comissões" />
                ...
                <Table>
                    ...
                    <tbody>
                        <tr className="bg-white border-b  hover:bg-gray-50 dark:hover:bg-gray-200">
                            ...
                            <td className="px-6 py-4">Marcus Vinicius</td>
                            ...
                            <td className="px-6 py-4">Reforma sala reuniões</td>
                            ...
                            {/* <td className="px-6 py-4 cursor-pointer">
                                <div onClick={() => router.push(`/comission/1`)}>
                                    <a
